...
import * as strings from 'YearChartsWebPartStrings';
import YearCharts from './components/YearCharts';
import { IYearChartsProps } from './IYearChartsWebPartProps';
import { MChart } from './IYearChartsWebPartProps';
import { IYearChartsWebPartProps } from './IYearChartsWebPartProps';
import { ChartConfiguration } from './IYearChartsWebPartProps';
...
export default class YearChartsWebPart extends BaseClientSideWebPart<IYearChartsWebPartProps> {

  private reactCharts: React.ReactElement<IYearChartsProps>;
  ...
  private getCharts(charts: Array<MChart>): void {
    const chartArea: React.ReactElement<IYearChartsProps> = React.createElement(
      YearCharts, {
  ...
  public getData(chartConfig: Object) {
    ...
    const resturl = `/_api/web/lists/GetByTitle(\'${chartConfig['list']}\')/items?$orderby=Stamp_Name_txt desc&$limit=10&$top=${this.properties.maxResults}&$filter=Status eq '${this.properties.dropdown}' and Year eq '${this.properties.year}'`;
